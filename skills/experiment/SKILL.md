...
7. Log the result:
   ```bash
   ./scripts/track-experiment.sh <agent> "<hypothesis>" <KEPT|DISCARDED|FAILED> ["notes"] ["technique"]
   ```
...
**Every 5th iteration** — update `shared/agent-journal/<agent>.md`:
```markdown
## Strategy
<why you're pursuing this direction, what triggered it>

## Learnings
- <insight from recent experiments>

## Next To Try
1. <planned hypothesis and why>
```
